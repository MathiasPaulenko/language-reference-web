    ...
    <html lang="en">
      ...
      <body>
        <div class="container">
          ...
          <p class="subtitle">XML sitemap for search engines. This page is a human-readable view.</p>
          <div class="stats">
            <div class="stat">
            ...
            <div class="stat">
              <div class="stat-value"><xsl:value-of select="count(s:urlset/s:url/s:xhtml:link)"/></div>
              ...
              <xsl:for-each select="s:urlset/s:url">
                <tr>
                  <td>
                    ...
                    <xsl:if test="s:xhtml:link">
                      <div class="alt-links">
                        <xsl:for-each select="s:xhtml:link">
                  ...
                  <td>
                    <xsl:choose>
                      <xsl:when test="s:xhtml:link">
                        <xsl:value-of select="count(s:xhtml/link)"/>
                      </xsl:when>
                      <xsl:otherwise>—</xsl:otherwise>
                    </xsl:choose>
                  </td>
